...
Проект по промышленной сборке многомодульного C/C++ кода с использованием **CMake**, **GoogleTest**, покрытия кода, линтинга и профилей сборки.
...
* CMake 3.11+
* Google Test
* Bash-скрипты, Python3 (линтер)
* gcc-14 / clang-14, gcov, lcov, genhtml
